...
public class CreateProject {
	...
	public void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			log.info("The Application has modified the project Succesfully!!!!");
		}catch(Exception e)
		{
			log.error("There is an exception araised during the execution of the modify project Method , Exception :"+e);
